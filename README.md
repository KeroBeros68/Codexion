...
### Concurrency theory
- Coffman, E.G. et al. — *System Deadlocks* (1971) — original formulation of the four necessary conditions for deadlock
...
- **Refactoring suggestions**: extracting named `#define` constants for log strings and ANSI color codes

All generated suggestions were reviewed, tested with Valgrind/Helgrind, and adapted before integration.
